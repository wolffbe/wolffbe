...
|--------|--------|---------|--------------|---------|
| [banter](https://github.com/wolffbe/banter) (2026) | AI agent tools | Evaluation framework for optimizing the cost, latency and quality of AI agents invoking MLOps platform interfaces | OpenCode, Python, bash, MCP, MLE-bench, Hopsworks | Master's thesis planned for publication at [IEEE ICA 2026](https://attend.ieee.org/ica-2026/) |
| [dmas-memory](https://github.com/wolffbe/dmas-memory) (2026) | AI agent memory | Evaluation framework for assessing long-context memory retrieval and cost in distributed LLM-based multi-agent systems | Python, Docker, OpenAI, Ollama, Prometheus, mem0, Graphiti, Neo4j | [Paper](https://arxiv.org/abs/2601.07978) accepted at [IEEE COMPSAC 2026](https://ieeecompsac.computer.org/2026/) |
