...
|--------|--------|---------|--------------|---------|
| [mlpab](https://github.com/wolffbe/mlpab) (2026) | Machine learning agents | Evaluation framework for coding agents operating feature, training and inference pipelines in MLOps platforms | Claude Code, Codex, Mistral, Databricks, Hopsworks | Master's thesis planned for publication at [IEEE ICA 2026](https://attend.ieee.org/ica-2026/) |
