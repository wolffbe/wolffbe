...
|--------|--------|---------|--------------|---------|
| [banter](https://github.com/wolffbe/banter) (2026) | AI agent tools | Evaluation framework for optimizing the cost, latency and quality of coding agents invoking MLOps platform interfaces | OpenCode, Python, bash, MCP, MLE-bench, Hopsworks | Master's thesis planned for publication at [IEEE ICA 2026](https://attend.ieee.org/ica-2026/) |
