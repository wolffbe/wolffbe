...
|---------|----------|--------------|-----------|
| [mlfs-book](https://github.com/wolffbe/mlfs-book) (2025) | MLOps | Python, Hopsworks AI Feature Store, WXGBoost, GitHub Actions | Air quality model training feature data backfilling, training and inference |
